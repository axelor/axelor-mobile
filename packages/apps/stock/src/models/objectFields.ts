...
export const stock_modelAPI: ObjectFields = {
  stock_customerDelivery: schemaContructor.object({
    ...
    forwarderPartner: schemaContructor.subObject(),
    freightCarrierMode: schemaContructor.subObject().concat(
      schemaContructor.object({
        shipmentMode: schemaContructor.subObject(),
        carrierPartner: schemaContructor.subObject(),
      }),
    ),
  }),
