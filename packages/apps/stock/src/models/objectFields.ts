...
export const stock_modelAPI: ObjectFields = {
  ...
  stock_logisticalForm: schemaContructor.object({
    ...
    accountSelectionToCarrierSelect: schemaContructor.number(),
    customerAccountNumberToCarrier: schemaContructor.string(),
    forwarderPartner: schemaContructor.subObject('simpleFullName'),
    incoterm: schemaContructor.subObject('name'),
    tracking: schemaContructor.string(),
      ...
      schemaContructor.object({
        stockConfig: schemaContructor.subObject().concat(
          schemaContructor.object({
            ...
            isRequiredShipmentSupplierDetails: schemaContructor.boolean(),
          }),
        ),
      }),
    ),
