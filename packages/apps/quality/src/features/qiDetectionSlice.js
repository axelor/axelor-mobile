...
export const searchQIDetection = createAsyncThunk(
  ...
  async function (data, {getState}) {
    return handlerApiCall({
      fetchFunction: _searchQIDetection,
      data,
      action: 'Quality_SliceAction_SearchQIDetection',
      getState,
...
const qiDetectionSlice = createSlice({
  name: 'quality_qiDetection',
  initialState,
  extraReducers: builder => {
    generateInifiniteScrollCases(builder, searchQIDetection, {
      loading: 'loadingQiDetections',
...
export const qiDetectionReducer = qiDetectionSlice.reducer;
