...
export const crm_modelAPI: ObjectFields = {
  ...
  crm_client: schemaContructor.object({
    ...
    'mainAddress.addressL4': schemaContructor.string(),
    'mainAddress.addressL7Country': schemaContructor.subObject('name'),
    'mainAddress.city': schemaContructor.subObject('name'),
    'mainAddress.zip': schemaContructor.string(),
