  ...
  return (
    <View>
      ...
      {!checkNullString(tradingName) && (
        <LabelText title={I18n.t('Sales_TradingName')} value={tradingName} />
      )}
      {!checkNullString(stockLocationName) && (
        <LabelText
          title={I18n.t('Sales_StockLocation')}
          value={stockLocationName}
        />
      )}
      {!checkNullString(externalReference) && (
        <LabelText
          title={I18n.t('Sales_CustomerReference')}
          value={externalReference}
        />
      )}
      {!checkNullString(fiscalPositionName) && (
        <LabelText
          title={I18n.t('Sales_FiscalPosition')}
          value={fiscalPositionName}
        />
      )}
      {!checkNullString(invoicedPartnerName) && (
        <LabelText
          title={I18n.t('Sales_InvoicedPartner')}
      ...
      {!checkNullString(deliveredPartnerName) && (
        <LabelText
          title={I18n.t('Sales_DeliveredPartner')}
