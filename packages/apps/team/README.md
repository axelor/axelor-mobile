...
<h1 align="center">@axelor/aos-mobile-team</h1>
...
The purpose of this package is to link with the team module of the [Axelor Open Suite (AOS)](https://github.com/axelor/axelor-open-suite) ERP. It provides a simplified version of a number of processes available on the webapp. This package is compatible with AOS from version 9.2.0.
...
```bash
yarn add @axelor/aos-mobile-team
```
...
const App = () => {
  return <Application modules={[TeamModule]} mainMenu="auth_menu_user" />;
};
