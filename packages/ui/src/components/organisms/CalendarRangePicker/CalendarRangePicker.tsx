...
const CalendarRangePicker = ({
  ...
  const handleDayPress = useCallback(
    (dateString: string) => {
      ...
      if (readonly || (disableFullDaySelection && isDayFull(mark))) return;

      applySelection(dateString);
    },
    [applySelection, disableFullDaySelection, readonly, renderEvent],
  );
  ...
  const todayIndex = useMemo(
    () => monthIndexOf(months, todayDateString),
