...
const useSampleData = () => {
  ...
  return useMemo(() => {
    ...
    const refused = Colors.errorColor;
    ...
    const refusedDay = {
      id: 7,
      label: 'Refused leave, full day, still selectable',
    };
    ...
    const marksByDate = {
      ...
      // Both halves marked, but `fullDay` overrides the inferred state: the
      // day stays bookable and the sheet still offers to select it.
      [shiftedDate(12)]: {
        morningColor: refused,
        afternoonColor: refused,
        events: [refusedDay],
        fullDay: false,
      },
    };
    ...
    const legendItems = [
      ...
      {key: 'refused', title: 'Refused', color: refused},
