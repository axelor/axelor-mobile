...
export const core_modelAPI: ObjectFields = {
  ...
  core_metaField: schemaContructor.object({
    name: schemaContructor.string(),
  }),
  core_metaSelectItem: schemaContructor.object({
    title: schemaContructor.string(),
    value: schemaContructor.string(),
    order: schemaContructor.number(),
    hidden: schemaContructor.boolean(),
    select: schemaContructor.subObject('name'),
  }),
  core_metaJsonField: schemaContructor.object({
    name: schemaContructor.string(),
    title: schemaContructor.string(),
    type: schemaContructor.string(),
    sequence: schemaContructor.number(),
    modelField: schemaContructor.string(),
    uniqueModel: schemaContructor.string(),
    help: schemaContructor.string(),
    widget: schemaContructor.string(),
    widgetAttrs: schemaContructor.string(),
    defaultValue: schemaContructor.string(),
    scale: schemaContructor.number(),
    hidden: schemaContructor.boolean(),
    hideIf: schemaContructor.string(),
    showIf: schemaContructor.string(),
    required: schemaContructor.boolean(),
    requiredIf: schemaContructor.string(),
    readonly: schemaContructor.boolean(),
    readonlyIf: schemaContructor.string(),
    valueExpr: schemaContructor.string(),
    isSelectionField: schemaContructor.boolean(),
    selection: schemaContructor.string(),
    targetModel: schemaContructor.string(),
    domain: schemaContructor.string(),
    onClick: schemaContructor.string(),
    contextField: schemaContructor.string(),
    contextFieldValue: schemaContructor.string(),
  }),
};
